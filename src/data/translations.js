const translations = {
  uz: {
    ...
    footer: {
      ...
      submit: "Yuborish",
      desc: "Tympanoplastika — Toshkentdagi zamonaviy endoskopik LOR markazi. Yuqori sifatli diagnostika va davolash xizmatlari.",
      links: "Havolalar",
      ...
      copyright: "© 2024 Tympanoplastika. Barcha huquqlar himoyalangan.",
    },
    modal: {
  ...
  oz: {
    ...
    footer: {
      ...
      submit: "Юбориш",
      desc: "Tympanoplastika — Тошкентдаги замонавий эндоскопик ЛОР маркази. Юқори сифатли диагностика ва даволаш хизматлари.",
      links: "Ҳаволалар",
      ...
      copyright: "© 2024 Tympanoplastika. Барча ҳуқуқлар ҳимояланган.",
    },
    modal: {
  ...
  ru: {
    ...
    footer: {
      ...
      submit: "Отправить",
      desc: "Tympanoplastika — современный эндоскопический ЛОР-центр в Ташкенте. Высококачественная диагностика и лечение.",
      links: "Ссылки",
      aboutUs: "О нас",
      contactUs: "Контакты",
      ourServices: "Услуги",
      ...
      copyright: "© 2024 Tympanoplastika. Все права защищены.",
    },
    modal: {
  ...
  en: {
    ...
    footer: {
      ...
      submit: "Submit",
      desc: "Tympanoplastika — Modern endoscopic ENT center in Tashkent. High quality diagnostics and treatment services.",
      links: "Quick Links",
      aboutUs: "About Us",
      ...
      copyright: "© 2024 Tympanoplastika. All Rights Reserved.",
    },
    modal: {
